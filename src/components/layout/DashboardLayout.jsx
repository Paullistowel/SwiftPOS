          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6">
            ...
            <div className="flex items-center gap-2 relative">
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 bg-red-500 text-white text-[10px] font-bold rounded-full border-2 border-surface-50 dark:border-surface-900 flex items-center justify-center">
                    {unreadCount > 99 ? '99+' : unreadCount}
                  </span>
                )}
                {unreadCount === 0 && (
                  <span
                    className={`absolute top-1 right-1 w-2 h-2 rounded-full border-2 border-surface-50 dark:border-surface-900 ${connected ? 'bg-emerald-400' : 'bg-amber-400 animate-pulse'}`}
                  />
                )}
              </button>
